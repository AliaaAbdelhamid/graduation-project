...
<button class="btn" style="background:  #0FB78D ; "> <?php if(@$_GET['q']==0)?><a style="text-decoration: none; color: white;" href="exam.php?q=0">Home<span class="sr-only">(current)</span></a></button>
<button class="btn" style="background:  #0FB78D ;"> <?php if(@$_GET['q']==2)?><a style="text-decoration: none; color: white;" href="exam.php?q=2">User Rankings</a></button>
<button class="btn" style="background:  #0FB78D ;"> <?php if(@$_GET['q']==4)?><a style="text-decoration: none; color: white;" href="exam.php?q=4">Add Exams</a></button>
...
<?php
$result = mysqli_query($dp,"SELECT * FROM exam ORDER BY date DESC") or die('Error');
...
while($row = mysqli_fetch_array($result)) {
	...
	<td><b><a href="examupdate.php?q=rmquiz&eid='.$eid.'" class="pull-right btn btn-danger" style="margin:0px; border-radius:0%;"><span class="glyphicon glyphicon-trash"  aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></td></tr>';
}
$c=0;
echo '</table></div>';
...
{
   ?> <div class="col-sm-3">
            <input type="text" id="myInput" onkeyup="myFunction()" class="form-control mb-5" placeholder="Search by exam title..">
        </div>
        <?php
$q=mysqli_query($dp,"SELECT * FROM rankexam  ORDER BY score DESC " )or die('Error223');
...
while($row=mysqli_fetch_array($q12) )
{
    ...
    $q123=mysqli_query($dp,"SELECT * FROM exam WHERE class_id=1 " )or die('Error231');
...
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Exam Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6"> 
   <form class="form-horizontal title1" name="form" action="examupdate.php?q=addquiz"  method="POST">
<fieldset>
...
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Question Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6"><form class="form-horizontal title1" name="form" action="examupdate.php?q=addqns&n='.@$_GET['n'].'&eid='.@$_GET['eid'].'&ch=4 "  method="POST">
<fieldset>
';
