...
<div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="PRIMprofile.php" method="POST"  enctype="multipart/form-data">
...
<div class="modal fade" id="deletemodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="PRIMprofile.php" method="POST">
          <div class="modal-body">
  ...
  <div class="content-wrapper">
        ...
        <div class="row m-1">
          ...
          <div class="col-sm-9">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"></li>Primary</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
           ...
           <button class="btn mt-5" style="background: #82B4BB;"><a href="#" onclick="history.back()" style="text-decoration: none; color: white;">Back</a></button>
