...
<div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="KGprofile.php" method="POST"  enctype="multipart/form-data">
...
<div class="modal fade" id="deletemodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="KGprofile.php" method="POST">
          <div class="modal-body">
...
if(isset($_POST['deletedata']))
{
    ...
    $query1 = " DELETE FROM `parent` where student_id = '$id'";
    $query1_run = mysqli_query($dp,$query);
        ...
        <div class="row m-1">
          ...
          <div class="col-sm-9">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"></li>KG <?php echo ucfirst( $_SESSION['link'])?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
