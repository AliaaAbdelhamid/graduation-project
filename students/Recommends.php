...
<div class="wrapper">
  ...
  <section class="content">
      <div class="container-fluid">
       ...
       <hr>
            <?php
              $query = 'SELECT * FROM `mark` INNER JOIN subject ON mark.subject_id = subject.subject_id
              WHERE student_id = "'. $_SESSION['student_id'].'" and class_id="'. $_SESSION['class_id'].'"';
...
<?php
            ...
            ?>
              <table id="myTable" class="customers" >
                ...
                <th>comments</th>             
                  ...
                  <tbody>
                  <tr>
                      <td><b style="font-weight: bold;">Subject : </b><?php echo $row['name'] ;?></td>
           ...
           <button class="btn mt-5" style="background: #0FB78D;"><a href="student_Profile.php" onclick="history.back()" style="text-decoration: none; color: white;">Back</a></button>
