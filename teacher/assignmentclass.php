    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"></li>Class Assigments</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
     ...
     ON teacher_classes.teacher_id ='{$_SESSION["teacher_id"]}' AND teacher_classes.class_id=classes.ID";
                 ...
                 if($res->num_rows>0)
                 {
                  ...
                  ?>
                        <li><a class="dropdown-item" href="student_assignments.php?class=<?php echo $row['class_id'] ?>"><?php echo $row['class']?> </a></li>
