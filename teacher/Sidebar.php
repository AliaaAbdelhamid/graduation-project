...
<body>
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <!-- Left navbar links -->
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="#" class="nav-link"><h1 style="color:#0FB78D;font-size:18px;"><b><?php echo $_SESSION['email']?></h1>  </b></a>
            </li>
            </ul>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" style="width: 150px;">
          <li class="nav-item menu-open" >
            <a href="Teacher_Profile.php" class="nav-link active" style="background-color:#0FB78D;">
          ...
          <li class="nav-item">
            ...
            <i class="nav_icon fas fa-sticky-note"></i>
            <p>
                  Add Assignments
                <i class="fas fa-angle-left right"></i>
              </p>
          ...
          <li class="nav-item">
            <a href="assignmentclass.php" class="nav-link">
            <i class="nav_icon fas fa-paper-plane"></i>
            <p>
            Student Assignments
                <i class="fas fa-angle-left right"></i>
              </p>
          ...
          <li class="nav-item">
            <a href="academic_syllabus.php" class="nav-link">
              <i class="nav_icon fas fa-book"></i>
              <p>
              academic_syllabus
                  <i class="fas fa-angle-left right"></i>
                </p>
          ...
          <li class="nav-item">
            ...
            <i class="nav_icon fas fa-align-left"></i>
            <p>
            Question Bank
                <i class="fas fa-angle-left right"></i>
              </p>
